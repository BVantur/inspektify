...
internal sealed interface NetworkTrafficDetailsUserAction : UserAction {
    ...
    data object OnDownload : NetworkTrafficDetailsUserAction
    ...
    data object DismissShareDialog : NetworkTrafficDetailsUserAction
    data class DownloadFile(val downloadFileType: DownloadFileType) : NetworkTrafficDetailsUserAction
}
